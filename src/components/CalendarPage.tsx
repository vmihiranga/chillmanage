    ...
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      {isAdmin && (
        <button
          ...
          className="fixed bottom-8 right-6 z-50 flex items-center justify-center w-14 h-14 bg-orange-500 text-white rounded-2xl shadow-xl shadow-orange-200 active:scale-90 transition-all sm:hidden"
        >
